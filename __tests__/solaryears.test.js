...
describe('SolarYears', () => {
  ...
  test('should contain a method that can determine how many years have passed since the users past birthday for each planet, and stores the result in a new property for each planet', () => {
